...
def main() -> None:
    ...
    from src.clean_data_v1 import build_summary_table, load_inputs
    from src.file_stuff import ensure_folder, save_csv
    from src.plot_helpers import make_revenue_plot
